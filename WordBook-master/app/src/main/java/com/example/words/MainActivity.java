...
public class MainActivity extends AppCompatActivity
    ...
    private String clientID="lumengqi0402@126.com";
    private String clientSecret="0043wang.qipi";
        ...
        Runnable askForYouDao = new Runnable() {
            ...
            public void run() {//连接网络接口
                try {
                    ...
                    HttpURLConnection connection = (HttpURLConnection) getUrl.openConnection();//HttpURLConnection发送get请求
                    connection.setConnectTimeout(3000);//设置建立连接的超时线程
                    connection.connect();
                    ...
                    JSONObject replyJson = new JSONObject(reply);//bianli得到的回应
